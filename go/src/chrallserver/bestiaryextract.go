...
func pxkill(niveauTueur int, niveauTué int) int {
...
func (be *BestiaryExtract) getGainPx(niveauTueur int) string {
...
func (be *BestiaryExtract) getPvRestant(pourcentageBlessure int) (pvMin, pvMax int) {
