	...
	chrall.warnOnTp = function(){
		...
		function writeWarning(){
			var	x= parseInt(document.getElementsByName('ai_OrigineX')[0].value),
				y= parseInt(document.getElementsByName('ai_OrigineY')[0].value),
				z= parseInt(document.getElementsByName('ai_OrigineN')[0].value);
			if (x*y*z!=x*y*z) $warn.hide();
			else $warn.text(teleportHoleMessage(x, y, z)).show();
		}
		writeWarning();
