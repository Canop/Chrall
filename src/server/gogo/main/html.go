...
func (cdm *CDM) HtmlTable() string {
	...
	lc = addUintsNV(lc, "Armure physique", cdm.ArmurePhysique_min, cdm.ArmurePhysique_max)
	lc = addUintsNV(lc, "Armure magique", cdm.ArmureMagique_min, cdm.ArmureMagique_max)
